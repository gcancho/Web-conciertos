        ...
        <div id="eventos" class="eventos clearfix">
             ...
             <div id="resumen" class="resumen">
                ...
                <div class="caja clearfix">
                      <div class="extras">
                            <div class="orden">
                                <label for="camisa_evento">Polo del evento S/ 20 <small>(promocion 15% dto.)</small></label>
                            ...
                            <div class="orden">
                                <label for="regalo">Elja su regalo de cortesía</label> <br>
                                <select id="regalo" name="regalo" required>
                                    <option value="">- Seleccione un regalo --</option>
                                    <option value="2">Pulseras</option>
                                    <option value="1">Mascarillas</option>
...
<script>
const lunes = document.querySelector('#Monday h4');
const martes = document.querySelector('#Tuesday h4') ;
const miercoles = document.querySelector('#Wednesday h4');
const jueves = document.querySelector('#Thursday h4');
const viernes = document.querySelector('#Friday h4');
const sabado = document.querySelector('#Saturday h4');
const domingo = document.querySelector('#Sunday h4');

viernes.innerText = 'Viernes';
